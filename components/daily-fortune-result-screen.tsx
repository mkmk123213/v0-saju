  ...
  return (
    <div className="flex min-h-screen flex-col relative overflow-hidden bg-gradient-to-b from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30">
      ...
      <div className="mx-auto w-full max-w-md px-4 pb-10 pt-6 relative z-10">
        ...
        {/* Profile Card - Premium Dark Theme */}
        <Card className="border-none overflow-hidden shadow-2xl mb-4">
          <div className="relative px-5 py-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            {/* Subtle glow effects */}
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-violet-500/20 blur-3xl" />
              <div className="absolute -bottom-8 -left-8 h-28 w-28 rounded-full bg-indigo-500/15 blur-3xl" />
            </div>
            
            {/* Subtle border glow */}
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-violet-500/10 via-transparent to-indigo-500/10" />

            <div className="relative flex items-center gap-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-500/30 to-indigo-500/30 backdrop-blur-sm border border-white/10 shadow-lg">
            ...
            {(zodiacAnimal || sunSign) && (
              <div className="relative mt-4 flex flex-wrap items-center gap-2">
                {zodiacAnimal && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-violet-500/20 border border-violet-400/30 px-3 py-1.5 text-xs font-semibold text-violet-300">
                    <Stars className="h-3.5 w-3.5" />
                    {zodiacAnimal}
                  </span>
                )}
                {sunSign && (
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-indigo-500/20 border border-indigo-400/30 px-3 py-1.5 text-xs font-semibold text-indigo-300">
